...
CURATED = [
    ...
    ("c-psa", [1, 3], "support_with_modification",
    ...
    # Q7
    ("c-meridian", [7], "support_with_modification",
    ...
    ("c-sacm", [7, 9], "support_with_modification",
    ...
    ("c-bramble", [7, 18], "support_with_modification",
    ...
    ("c-lumen", [7], "support_with_modification",
    ...
    # Q12 (cybersecurity)
    ("c-northlight", [12, 6], "support_with_modification",
    ...
    ("c-northlight", [13], "support_with_modification",
    ...
    ("c-cces", [13, 9], "support_with_modification",
    ...
    # Q19
    ("c-amtc", [19], "support_with_modification",
    ...
    ("c-perrin", [19], "support_with_modification",
    ...
    ("c-nrpc", [19, 20], "support_with_modification",
    ...
    ("c-kestrel", [19], "support_with_modification",
    ...
    # Q21
    ("c-calder", [21], "support_with_modification",
     "Supports predetermined change control but says the current PCCP construct does not fit changes the sponsor did not initiate.",
    ...
    ("c-ashford", [21, 24], "support_with_modification",
    ...
    ("c-halden", [21, 22], "support_with_modification",
    ...
    ("c-weston", [24], "support_with_modification",
    ...
    ("c-greatlakes", [24, 19], "support_with_modification",
    ...
    # Q25
    ("c-dhif", [25], "support_with_modification",
    ...
    ("c-orbis", [25], "support_with_modification",
     "Supports voluntary master files and says they will only be maintained if FDA staff actually rely on them.",
    ...
    ("c-kestrel", [25, 21], "support_with_modification",
...
ISSUE_BY_QUESTION = {
    2: ("intended_use", "regulatory_scope"), 3: ("directiveness", "risk_classification"),
    4: ("human_factors", "directiveness"), 5: ("risk_classification", "statistical_methods"),
    6: ("risk_classification", "cybersecurity"), 8: ("benchmarking", "evidence_standards"),
    9: ("clinical_validation", "comparator_standard_of_care"), 10: ("benchmarking", "synthetic_data"),
    11: ("clinical_validation", "evidence_standards"), 12: ("cybersecurity", "statistical_methods"),
    14: ("intended_use", "human_factors"), 15: ("evidence_standards", "foundation_model_dependency"),
    16: ("foundation_model_dependency", "supplier_controls"), 17: ("comparator_standard_of_care", "statistical_methods"),
    18: ("postmarket_monitoring", "evidence_standards"), 20: ("postmarket_monitoring", "statistical_methods"),
    22: ("pccp", "change_control"), 23: ("postmarket_monitoring", "accountability_liability"),
}
GAP_BY_QUESTION = {
    2: ["dynamic_intended_use"], 3: ["dynamic_intended_use"], 4: ["human_ai_system_performance", "delegated_authority"],
    5: ["operational_harm"], 6: ["cybersecurity_as_safety"], 9: ["human_ai_system_performance"],
    10: ["deployment_assurance_scalability"], 16: ["ai_supplier_quality"], 18: ["evidence_burden_commercial_viability", "operational_harm"],
    20: ["operational_harm"], 23: ["operational_harm", "delegated_authority"],
}
